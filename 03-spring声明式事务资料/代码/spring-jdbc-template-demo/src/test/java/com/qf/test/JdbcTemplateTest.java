...
public class JdbcTemplateTest {
    ...
    public void test4(){
        ...
        Student student = jdbcTemplate.queryForObject("select * from student where sno=?", new BeanPropertyRowMapper<>(Student.class), 201215121L);
    ...
    public void test9(){
        ...
        map.put("sname","李勇");
        Integer result = namedParameterJdbcTemplate.queryForObject("select count(*) from student where sno=:sno and sname=:sname", map, Integer.class);
        System.out.println(result);
    }
